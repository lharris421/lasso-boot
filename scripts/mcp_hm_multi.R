...
# metropolis_hastings <- function(X, y, lambda, gamma, iter = 10000000, burn_in = 9990000) {
metropolis_hastings <- function(X, y, lambda, gamma, iter = 100000000, burn_in = 99000000) {
