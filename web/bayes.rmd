...
eb_boot_sim <- function(beta, p = 60, b = 2, n = 100, niter = 100, nboot = 100) {
  ...
  indiv_width <- matrix(nrow = nboot, ncol = p)
  ...
  for (iter in 1:nboot) {
    ...
    indiv_width[iter,] <- colMeans(res[["upper"]] == res[["lower"]])
  ...
  return(list("overall_cov" = overall_cov, "indiv_cov" = indiv_cov, "truth" = tbeta, "indiv_width" = indiv_width))
