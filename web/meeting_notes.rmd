...
- [ ] Derive normal approximation throw taylor series expansion as comparison
...
- [ ] Profile code to see what is expensive, I think it may be
...
- [x] Look into bridge sampling
  - Seems more like a method to compute the marginal likelihood which doesn't seem directly relavent for the current context since we really need to get directly at the posterior
