...
proxy_dist <- function(dist1, dist2) round(mean(abs(sort(abs(dist1)) - sort(abs(dist2)))), 3)
rlr <- function(dist1, dist2) {
  ...
  return(round(((move_right - move_left) / total_move)^(exact), 3))
}
...
print(paste0("Distance to prior: ", proxy_dist(prior, unif)))
print(paste0("Right-Left Ratio: ", rlr(prior, unif)))
