...
- If this idea would persist, we may wan to revert to the original definition for demonstration of the idea being linked to wasserstein distance.
...
ggplot() +
  ...
  geom_line(data = data.frame(x = c(.5, 2), y = c(0, 0)), aes(x = x, y = y))
