...
plot(density(prior, bw = 10 / 1000), col = "red")

prior <- rlaplace(n = 100000, location = 0, scale = .01)
plot(density(prior, bw = .01 / 1000), col = "red")
```
...
plot(density(truth, bw = .001, weights = (truth !=0) / sum(truth !=0)), col = "red", ylim = c(0, 20))
lines(density(truth, bw = .001, weights = (truth == 0) / sum(truth == 0)), col = "red")
```
